...
public class DefaultHandler implements EffectHandler {
  ...
  public void addEffect(Spell spell) {
    ...
    switch (spell.getEffect()) {
      case PARALYZE:
        target.addCondition(Condition.PARALYZED);
        break;
      case LEVITATE:
        target.addCondition(Condition.LEVITATE);
        break;
      case BLIND:
        target.addCondition(Condition.BLIND);
        break;
      case CALM:
        target.brain.calm();
        break;
      case SILENCE:
        target.addCondition(Condition.SILENCED);
        break;
      case BURDEN:
        target.addCondition(Condition.BURDENED);
        break;
      case CHARM:
  ...
  public void removeEffect(Spell spell) {
    ...
    switch (spell.getEffect()) {
      case LEVITATE:
        target.removeCondition(Condition.LEVITATE);
        break;
      case PARALYZE:
      ...
      case BLIND:
        ...
        break;
      case CALM:
        target.removeCondition(Condition.CALM);
        break;
      case SILENCE:
        target.removeCondition(Condition.SILENCED);
        break;
      case BURDEN:
        target.removeCondition(Condition.BURDENED);
        break;
      case CHARM:
        target.brain.charm((Creature) spell.getCaster(), -(int) spell.getMagnitude());
        break;
