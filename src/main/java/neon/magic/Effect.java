...
/**
 * Represents a magic effect. Every effect should belong to one of six magic schools: alteration,
 * restoration, illusion, destruction, conjuration or creation. These schools are skills a character
 * can have.
 *
 * <p>Every spell can have a 'duration type': instant, per round and timed. Instant means that it is
 * an instantaneous effect. Per round means that it can last several rounds, the effect being
 * applied every round. Timed means a constant effect that wears of after a certain time.
 *
 * @author mdriesen
 */
public enum Effect {
  ...
  FROST_SHIELD(
      Skill.CONJURATION, .3f, "frost shield", new ShieldHandler(Ability.COLD_RESISTANCE), 2),
  SHOCK_SHIELD(
      Skill.CONJURATION, .3f, "shock shield", new ShieldHandler(Ability.SHOCK_RESISTANCE), 2),
  ...
  DRAIN_CREATION(
      Skill.DESTRUCTION, .5f, "drain creation", new DrainSkillHandler(Skill.CREATION), 2),
  DRAIN_DESTRUCTION(
      Skill.DESTRUCTION, .5f, "drain destruction", new DrainSkillHandler(Skill.DESTRUCTION), 2),
  DRAIN_RESTORATION(
      Skill.DESTRUCTION, .5f, "drain restoration", new DrainSkillHandler(Skill.RESTORATION), 2),
  DRAIN_ALTERATION(
      Skill.DESTRUCTION, .5f, "drain alteration", new DrainSkillHandler(Skill.ALTERATION), 2),
  DRAIN_ILLUSION(
      Skill.DESTRUCTION, .5f, "drain illusion", new DrainSkillHandler(Skill.ILLUSION), 2),
  DRAIN_ALCHEMY(Skill.DESTRUCTION, .5f, "drain alchemy", new DrainSkillHandler(Skill.ALCHEMY), 2),
  DRAIN_ENCHANT(
      Skill.DESTRUCTION, .5f, "drain enchanting", new DrainSkillHandler(Skill.ENCHANT), 2),
  ...
  DRAIN_CLIMBING(
      Skill.DESTRUCTION, .5f, "drain climbing", new DrainSkillHandler(Skill.CLIMBING), 2),
  DRAIN_SWIMMING(
      Skill.DESTRUCTION, .5f, "drain swimming", new DrainSkillHandler(Skill.SWIMMING), 2),
  DRAIN_HEAVY_ARMOR(
      Skill.DESTRUCTION, .5f, "drain heavy armor", new DrainSkillHandler(Skill.HEAVY_ARMOR), 2),
  DRAIN_MEDIUM_ARMOR(
      Skill.DESTRUCTION, .5f, "drain medium armor", new DrainSkillHandler(Skill.MEDIUM_ARMOR), 2),
  DRAIN_LIGHT_ARMOR(
      Skill.DESTRUCTION, .5f, "drain light armor", new DrainSkillHandler(Skill.LIGHT_ARMOR), 2),
  ...
  DRAIN_MERCANTILE(
      Skill.DESTRUCTION, .5f, "drain mercantile", new DrainSkillHandler(Skill.MERCANTILE), 2),
  DRAIN_PICKPOCKET(
      Skill.DESTRUCTION, .5f, "drain pickpocket", new DrainSkillHandler(Skill.PICKPOCKET), 2),
  DRAIN_ARMORER(Skill.DESTRUCTION, .5f, "drain armorer", new DrainSkillHandler(Skill.ARMORER), 2),
  DRAIN_LOCKPICKING(
      Skill.DESTRUCTION, .5f, "drain lockpicking", new DrainSkillHandler(Skill.LOCKPICKING), 2),
