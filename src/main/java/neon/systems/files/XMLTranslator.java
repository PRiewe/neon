 ...
 *     <ul>
 *       <li>ModLoader - Uses for loading mods (deferred to Phase 7)
 *       <li>Editor - Uses for map/resource editing (minimal migration in Phase 6)
 *       <li>SVGLoader - Uses for SVG parsing (Phase 5D)
 *     </ul>
