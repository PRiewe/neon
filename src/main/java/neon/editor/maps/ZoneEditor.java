...
public class ZoneEditor implements ActionListener {
  ...
  private void save() {
    ...
    if (themeBox.getSelectedItem() != null) {
      String question =
          "You have set a dungeon theme. Saving will delete all current zone contents. Do you wish to continue?";
      if (zone.getScene().getElements().isEmpty()
          || JOptionPane.showConfirmDialog(
                  frame, question, "Theme warning", JOptionPane.YES_NO_OPTION)
  ...
  private class InstanceEditor extends AbstractCellEditor
    ...
    public JComponent getTableCellEditorComponent(
        JTable table, Object object, boolean isSelected, int row, int column) {
