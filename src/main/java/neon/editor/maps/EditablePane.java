...
public class EditablePane extends JScrollPane
  ...
  public void mouseClicked(MouseEvent e) {
    ...
    if (e.getClickCount() == 2 && e.getButton() == MouseEvent.BUTTON1 && selected != null) {
      ...
      menu.add(
          new ClickAction(
              "Properties...",
              selected instanceof IContainer
                  || selected instanceof IDoor
                  || selected instanceof IRegion));
  ...
  public void mouseMoved(MouseEvent e) {
    Editor.getStatusBar()
        .setMessage(
            "x: "
                + (int) (e.getX() / pane.getZoom())
                + ", y: "
                + (int) (e.getY() / pane.getZoom()));
  }
  ...
  public void mousePressed(MouseEvent e) {
    if (MapEditor.drawMode()) {
      ...
      if (selected != null) {
        ...
        delta =
            new Dimension(
                selected.getBounds().x - (int) (e.getX() / pane.getZoom()),
  ...
  private class ClickAction extends AbstractAction {
    ...
    private Instance clone(Instance original) {
      ...
      cloneElement.setAttribute(
          "uid", Integer.toString(node.getZone().map.createUID(cloneElement)));
