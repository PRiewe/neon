        ...
        lockLayout
            ...
            .addGroup(
                lockLayout
                    ...
                    .addComponent(lockBox)
                    .addComponent(lockableHelpLabel))
            .addGroup(
                lockLayout
                    .createParallelGroup(GroupLayout.Alignment.BASELINE)
                    .addComponent(lockLabel)
                    .addComponent(lockSpinner)
                    .addComponent(lockHelpLabel))
            .addGroup(
                lockLayout
                    .createParallelGroup(GroupLayout.Alignment.BASELINE)
                    .addComponent(keyLabel)
                    .addComponent(keyBox)
                    .addComponent(keyHelpLabel)));
        ...
        trapLayout
            ...
            .addGroup(
                trapLayout
                    ...
                    .addComponent(trapBox))
            .addGroup(
                trapLayout
                    .createParallelGroup(GroupLayout.Alignment.BASELINE)
                    .addComponent(trapDCLabel)
                    .addComponent(trapSpinner))
            .addGroup(
                trapLayout
                    .createParallelGroup(GroupLayout.Alignment.BASELINE)
