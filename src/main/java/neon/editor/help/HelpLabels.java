...
public class HelpLabels {
  ...
  public static JLabel getAggressionHelpLabel() {
    return getLabel(
        "A higher aggression makes a creature more likely to fight when it meets an enemy.");
  }
  ...
  public static JLabel getArmorSlotHelpLabel() {
    return getLabel(
        "<html>The body part this piece of armor protects:<br>"
  ...
  public static JLabel getAttackHelpLabel() {
    return getLabel(
        "<html>The base unarmed damage this creature can do. The <br>"
            + "format is: &lt;number of dice&gt;d&lt;type of die&gt;+&lt;bonus&gt;.</html>");
  }

  public static JLabel getBigHelpLabel() {
    return getLabel(
        "<html>The name of large denomination coins (such as <i>euro</i> or <i>dollar</i> in real life).</html>");
  }

  public static JLabel getBookTextHelpLabel() {
    return getLabel(
        "<html>The name of the .html file containing the text of this book, <br>"
  ...
  public static JLabel getBranchHelpLabel() {
    return getLabel(
        "A high branching factor gives dungeons with more connections between the zones.");
  }
  ...
  public static JLabel getCharHelpLabel() {
    return getLabel(
        "The character this object will be represented with in the game. Default is 'X'.");
  }

  public static JLabel getClassHelpLabel() {
    return getLabel(
        "<html>The weight rating of an armor piece determines which skill is used for <br>"
            + "a combat defense check. The actual weight is not taken into account.");
  }

  public static JLabel getClosedHelpLabel() {
    return getLabel(
        "<html>The character this door will be represented with when closed. If no character <br>"
            + "is given, the open door character will be used.</html>");
  }

  public static JLabel getClothingEnchantmentHelpLabel() {
    return getLabel(
        "The optional enchantment on this clothing piece. It must be a constant effect.");
  }

  public static JLabel getClothingSlotHelpLabel() {
    return getLabel(
        "<html>The type of clothing. Gloves can't be worn together with bracers or <br>"
            + "gauntlets (armor). Shoes can't be worn together with boots (armor)</html>");
  }

  public static JLabel getColorHelpLabel() {
    return getLabel(
        "The color of the character this object will be represented with in the game. "
            + "Default is white.");
  }
  ...
  public static JLabel getDamageHelpLabel() {
    return getLabel(
        "<html>Determines the base damage this weapon can inflict. The format <br>"
            + "is: &lt;number of dice&gt;d&lt;type of die&gt;+&lt;bonus&gt;</html>");
  }

  public static JLabel getDefenseHelpLabel() {
    return getLabel(
        "Natural armor. Higher numbers mean more damage is absorbed before losing health.");
  }
  ...
  public static JLabel getDoorHelpLabel() {
    return getLabel(
        "<html>A list of doors that can appear in this zone. They <br>"
  ...
  public static JLabel getFactionHelpLabel() {
    return getLabel(
        "<html>The checkbox determines whether this NPC belongs to the selected <br>"
            + " faction. The spinner determines its rank within this faction.</html>");
  }

  public static JLabel getFloorHelpLabel() {
    return getLabel(
        "<html>A list of floor types that can appear in this zone. They <br>"
            + "should be separated by a comma (no spaces).</html>");
  }
  ...
  public static JLabel getHabitatHelpLabel() {
    return getLabel(
        "<html>The kind of habitat this creature is generally found in. This is mainly used in<br>"
  ...
  public static JLabel getHitHelpLabel() {
    return getLabel(
        "<html>Hit dice determine the starting health and health increases at level up. <br>"
  ...
  public static JLabel getItemHelpLabel() {
    return getLabel(
        "<html>The type of item this enchantment is used on. Clothing enchantments can be <br>"
  ...
  public static JLabel getLockedHelpLabel() {
    return getLabel(
        "<html>The character this door will be represented with when locked. If no character <br>"
  ...
  public static JLabel getManaHelpLabel() {
    return getLabel(
        "This number multiplied by Int determines the mana available to this creature.");
  }
  ...
  public static JLabel getNameHelpLabel() {
    return getLabel(
        "The name of this resource. If no name is given, " + "the object id will be used as name.");
  }
  ...
  public static JLabel getRangeHelpLabel() {
    return getLabel(
        "Maximum distance this creature will move from its starting position (guard AI only).");
  }
  ...
  public static JLabel getSizeHelpLabel() {
    return getLabel(
        "The size of this creature. Tiny creatures are shown at 2/3 scale in-game, "
            + "huge creatures at 3/2 scale.");
  }

  public static JLabel getSmallHelpLabel() {
    return getLabel(
        "<html>The name of small denomination coins, 1/100th <br>"
  ...
  public static JLabel getSpellRangeHelpLabel() {
    return getLabel(
        "<html>The range of this spell. The following values are valid:<br>"
  ...
  public static JLabel getSpellSizeHelpLabel() {
    return getLabel(
        "<html>The magnitude of the spell effect (a heal spell with <br>"
  ...
  public static JLabel getStartXLabel() {
    return getLabel(
        "The x-position where a new character will start. Make sure this position exists.");
  }

  public static JLabel getStartYLabel() {
    return getLabel(
        "The y-position where a new character will start. Make sure this position exists.");
  }

  public static JLabel getStartZoneLabel() {
    return getLabel(
        "<html>The zone where a new character will start. Only non-random zones <br>"
  ...
  public static JLabel getSVGHelpLabel() {
    return getLabel(
        "<html>Whether or not to render this object with custom SVG in <br>"
  ...
  public static JLabel getTitleHelpLabel() {
    return getLabel(
        "The title of this mod. It will be displayed on the start screen and in the title bar.");
  }

  public static JLabel getTopHelpLabel() {
    return getLabel(
        "<html>Whether or not this object is shown on top of all other objects <br>"
  ...
  public static JLabel getZoneHelpLabel() {
    return getLabel(
        "<html>The different zones that can be generated in this dungeon. The <br>"
