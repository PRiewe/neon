  ...
  public CreatureEditor(JFrame parent, RCreature rCreature, DataStore dataStore) {
        ...
        propsLayout
            ...
            .addGroup(
                propsLayout
                    ...
                    .addComponent(speedHelpLabel))
            .addGroup(
                propsLayout
                    .createParallelGroup(GroupLayout.Alignment.BASELINE)
                    .addComponent(hitLabel)
                    .addComponent(hitField)
                    .addComponent(hitHelpLabel))
            .addGroup(
                propsLayout
                    .createParallelGroup(GroupLayout.Alignment.BASELINE)
                    .addComponent(typeLabel)
                    .addComponent(typeBox)
                    .addComponent(typeHelpLabel))
            .addGroup(
                propsLayout
                    .createParallelGroup(GroupLayout.Alignment.BASELINE)
    ...
    AILayout.setVerticalGroup(
        AILayout.createSequentialGroup()
            .addGroup(
                AILayout.createParallelGroup(GroupLayout.Alignment.BASELINE)
    ...
    AILayout.setHorizontalGroup(
        AILayout.createSequentialGroup()
            .addGroup(
                AILayout.createParallelGroup(GroupLayout.Alignment.LEADING)
                    .addComponent(
                        aiTypeLabel,
                        GroupLayout.PREFERRED_SIZE,
                        GroupLayout.DEFAULT_SIZE,
                    ...
                    .addComponent(confidenceLabel))
            .addGroup(
                AILayout.createParallelGroup(GroupLayout.Alignment.LEADING, false)
                    .addComponent(
                        aiTypeBox,
                        GroupLayout.PREFERRED_SIZE,
                        GroupLayout.DEFAULT_SIZE,
