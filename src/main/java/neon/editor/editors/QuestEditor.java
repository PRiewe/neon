...
public class QuestEditor extends ObjectEditor implements ActionListener, MouseListener {
  ...
  public QuestEditor(JFrame parent, RQuest quest, DataStore dataStore) {
    ...
    varModel =
        new QuestsTableModel(varColumns, String.class, String.class, String.class, String.class);
    ...
    dialogModel =
        new QuestsTableModel(dialogColumns, String.class, String.class, String.class, String.class);
    ...
    public void actionPerformed(ActionEvent e) {
      if (e.getActionCommand().equals("Add condition")) {
        ...
        String s =
            (String)
                JOptionPane.showInputDialog(
                    frame, "Topic name:", "Add topic", JOptionPane.PLAIN_MESSAGE, null, null, "");
        if (s != null) {
          String[] row = {s, "", "", ""};
