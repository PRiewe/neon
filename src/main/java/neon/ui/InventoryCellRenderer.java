...
public class InventoryCellRenderer extends JLabel implements ListCellRenderer<Entity> {
  ...
  /**
   * Returns this renderer with the right properties (color, font, background color). If the player
   * has equiped the item in the cell, the text is rendered in bold.
   *
