...
public class TradeDialog implements KeyListener, ListSelectionListener {
  ...
  public TradeDialog(UserInterface ui, String big, String small) {
    ...
    // instructies geven
    JLabel instructions =
        new JLabel("Use arrows keys to select item, press space to buy/sell item, esc to exit.");
  ...
  public void valueChanged(ListSelectionEvent lse) {
    Entity item =
        buyList.getSelectedValue() != null
            ? buyList.getSelectedValue()
            : sellList.getSelectedValue();
