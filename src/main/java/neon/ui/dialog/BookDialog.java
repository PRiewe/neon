...
public class BookDialog implements KeyListener {
  ...
  public BookDialog(JFrame parent) {
    ...
    JLabel instructions =
        new JLabel("<html>Use arrows keys to scroll, press space to return to inventory.</html>");
  ...
  public void keyPressed(KeyEvent e) {
    int inc =
        area.getScrollableUnitIncrement(scroller.getVisibleRect(), SwingConstants.VERTICAL, 1);
