...
public class SpellMakerDialog {
  ...
  public SpellMakerDialog(UserInterface ui) {
    ...
    JLabel instructions =
        new JLabel(
            "Use tab to switch between the available options, press enter to purchase spell, esc to cancel.");
  ...
  private RSpell createSpell() {
    return new RSpell(
        nameField.getText(),
        (Integer) rangeSpinner.getValue(),
        (Integer) durationSpinner.getValue(),
        effectBox.getSelectedItem().toString(),
