...
public class CommandHistory {
  ...
  /**
   * Adds a command to this command history manager. Resets the command counter for which command to
   * select next/prev.<br>
   * If the number of remembered commands exceeds the capacity, the oldest item is removed.<br>
