...
public class JVectorPane extends JComponent implements MouseListener {
  ...
  private final HashSet<Renderable> selection; // snelle look-up
  ...
  public Rectangle getVisibleRectangle() {
    ...
    return new Rectangle(
        (int) (cx / zoom),
        (int) (cy / zoom),
        (int) (port.width / zoom + 1),
        (int) (port.height / zoom + 1));
  }
  ...
  public void mouseClicked(MouseEvent me) {
    for (VectorSelectionListener listener :
        listenerList.getListeners(VectorSelectionListener.class)) {
