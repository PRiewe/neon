...
public class Inventory implements Iterable<Long>, Component {
  ...
  /**
   * Puts an item in the given slot. This method does not check any of the consequences of equiping
   * an item.
   *
   * @param slot
   * @param uid
  ...
  /**
   * Removes the item in the given slot. This method does not check any of the consequences of
   * unequiping an item.
   *
   * @param slot
   */
  ...
  /**
   * Removes an item from this inventory. This method does not check the effects of unequiping said
   * item.
   *
