...
/**
 * This class represents the magical component of creatures. The total mana available is determined
 * as follows: mana = intelligence * base mana + base mana modifier + mana modifier.
 *
 * @author mdriesen
 */
public class Animus implements Component, Serializable {
  ...
  /**
   * Adds to the base mana modifier, lowering or raising the maximum amount of mana.
   *
  ...
  public int getMana() {
    return (int)
        (creature.getStatsComponent().getInt() * creature.getSpecies().mana
            + baseManaMod
            + manaMod);
  }
