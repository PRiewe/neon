...
public class HealthComponent implements Component, Serializable {
  ...
  /**
   * Returns the base health of this creature. It is the maximum health this creature can have
   * without using magical or other means.
   *
  ...
  /**
   * Returns the current health of this creature. It is the base health, modified with magical
   * effects, battle damage, etc.
   *
  ...
  /**
   * Adds to the base health modifier, lowering or raising the maximum attainable total health.
   *
