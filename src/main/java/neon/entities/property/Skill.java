...
/**
 * The different skills a creature can have. Each skill is governed by an attribute. Each skill
 * increase will also increase its attribute with a certain amount.
 *
 * @author mdriesen
 */
public enum Skill {
  // magic
  CREATION(Attribute.INTELLIGENCE, 0.1f),
  DESTRUCTION(Attribute.WISDOM, 0.1f),
  RESTORATION(Attribute.WISDOM, 0.1f),
  ALTERATION(Attribute.INTELLIGENCE, 0.1f),
  ILLUSION(Attribute.CHARISMA, 0.1f),
  ENCHANT(Attribute.INTELLIGENCE, 0.1f),
  ...
  // combat
  HEAVY_ARMOR(Attribute.STRENGTH, 0.1f),
  MEDIUM_ARMOR(Attribute.CONSTITUTION, 0.1f),
  LIGHT_ARMOR(Attribute.DEXTERITY, 0.1f),
  DODGING(Attribute.DEXTERITY, 0.1f),
  ...
  LOCKPICKING(Attribute.DEXTERITY, 0.1f),
  MEDICAL(Attribute.WISDOM, 0.1f),
  DISABLE(Attribute.INTELLIGENCE, 0.1f),
  SPEECHCRAFT(Attribute.CHARISMA, 0.1f),
  PERFORM(Attribute.CHARISMA, 0.1f),
