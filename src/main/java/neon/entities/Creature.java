...
/**
 * This class implements a general creature. Specific types of creatures can be subclassed from this
 * class.
 *
 * @author mdriesen
 */
public class Creature extends Entity {
   ...
   */
  /**
   * Returns the level of this creature. The level is based on a weighted average of this creature's
   * attributes.
   *
  ...
  public int getLevel() {
    return Math.max(
        1,
        (int) (species.str + species.iq + species.dex + species.con + species.cha + species.wis)
            / 6);
  }
