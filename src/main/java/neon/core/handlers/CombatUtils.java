...
public class CombatUtils {
  ...
  /**
   * The attack value determines how much damage this creature's weapons can deal.
   *
  ...
  /**
   * Does a block skill check. It is used to determine if this creature can block an attack. When no
   * shield or similar protective gear is equiped, this method returns 0;
   *
  ...
  /**
   * Does a dodge skill check. It is used to determine if this creature can dodge an attack.
   *
  ...
  /**
   * The defense value determines how much damage this creature can take without losing health.
   *
