...
/**
 * ColorFactory implements all "X11 colors" from the CSS3 specification as defined in the W3C
 * standard. Also included are some extra Netscape colors.
 *
 * @author mdriesen
 */
public class ColorFactory {
  ...
  /**
   * Returns the <code>Color</code> with the given name. Grey/gray variants are both valid. The name
   * of the color is given in Java style, e.g. darkSlateGray, beginning with a lowercase letter.
   *
