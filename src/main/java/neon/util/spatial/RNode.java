...
class RNode<E> {
  ...
  private final int max; // node size of the tree	(max number of elements in a node)
  private final int min; // fill factor of the tree	(min number of elements in a node)
