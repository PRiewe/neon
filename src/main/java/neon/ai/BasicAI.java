...
public class BasicAI extends AI {
  public BasicAI(Creature creature, byte aggression, byte confidence, GameContext gameContext) {
  ...
  public void act() {
    ...
    if (isHostile() && sees(gameContext.getPlayer())) {
